...
const Page = () => {
    ...
    return (
        <div className="h-screen flex items-center justify-center relative">
            <div className="p-8">
                <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    ...
                    <div className="grid w-full items-center gap-1.5">
                        ...
                        <Link className="hover:text-primary/80 t-muted-foreground text-sm ml-auto whitespace-nowrap" href={authLinksConfig.forgotPassword.href}>{authLinksConfig.forgotPassword.name}</Link>
                    </div>
            ...
            <Link href={authLinksConfig.signUp.href} className="absolute bottom-10 left-1/2 -translate-x-1/2 text-center"><span className="whitespace-nowrap">Vous n&apos;avez pas de compte ?</span> <span className="underline" >Inscrivez-vous</span></Link>
        </div>
    )
}
